...
namespace Final1_Colegio.Controllers
{
    public class NotesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdNote,Note1,Note2,IdStudent")] Note note)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdNote,Note1,Note2,IdStudent")] Note note)
        {
            if (ModelState.IsValid)
            {
